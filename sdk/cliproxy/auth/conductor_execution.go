...
// authAllowedByFreePolicy applies the disallow-free / only-free routing hints.
// Only-free keeps codex credentials whose plan is free or unknown so that a
// pool without plan metadata still serves free-only routes.
