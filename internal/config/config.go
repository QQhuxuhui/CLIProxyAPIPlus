...
type RoutingConfig struct {
	...
	// Claude Code session metadata, Session_id (Codex), X-Session-ID,
	// X-Session-Affinity, explicit body session/conversation fields,
	// X-Client-Request-Id (PI), metadata.user_id, or a message hash fallback.
